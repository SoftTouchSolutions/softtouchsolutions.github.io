...
import { a as useNavigate, R as Row, b as Link, C as Col, g as Card, h as CardBody, F as Form, I as Input, B as Button, S as Swal, A as APIServices } from "./index-CPwjB16p.js";
...
const Login01 = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await APIServices.login(credentials, null);
      console.log("Login successful:", response);
      if (response && response.message === "Login successful") {
        navigate(`${"/apps/nsh/"}dashboard/dashboard01`);
      } else {
      ...
      Swal.fire({
        icon: "error",
        title: "Login Failed",
        text: ((_b = (_a = error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.detail) || "Failed to authenticate. Please check your credentials."
      });
    } finally {
      setLoading(false);
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-single", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "justify-content-center", onClick: () => {
      switcherIconReomve();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Col, { md: 7, lg: 6, xl: 5, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: " p-4 mb-0 mt-7 mt-md-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { className: "", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { onSubmit: handleLogin, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "submit",
                className: "btn btn-lg btn-primary btn-block",
                disabled: loading,
                children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fa fa-spinner fa-spin" }),
                  " Logging in..."
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-weight-normal fs-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "btn-link font-weight-normal", to: `${"/apps/nsh/"}account/register/register01`, children: "Register Here" })
      ] }) })
    ] }) })
  ] }) }) }) });
};
