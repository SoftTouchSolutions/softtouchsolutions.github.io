...
import { R as Row, b as Link, C as Col } from "./index-CPwjB16p.js";
import "./vendor-DcOWwNOt.js";
import "./utils-pMlYcaaZ.js";
const fund = "/apps/nsh/assets/notfund-DxQRjItU.svg";
const Error403 = () => {
  document.querySelector("body").classList.add("main-body", "light-mode", "ltr", "error-page");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", onClick: () => {
      switcherIconReomve();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { md: 5, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: fund, alt: "img", className: "w-90" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-md-7 mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "display-2 text-primary  mb-2 font-weight-bold", children: " 403" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "h3  mb-3 font-weight-bold", children: "Sorry, Forbidden Error, Requested Page not found!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "h5 font-weight-normal mb-7 leading-normal", children: "You may have mistyped the address or the page may have moved." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { className: "btn btn-primary", to: `${"/apps/nsh/"}dashboard/dashboard01`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fe fe-arrow-left-circle m-1" }),
          "Back to Home"
        ] })
      ] })
    ] }) }) }) })
