...
import { m as mapToCssModules, i as classnames, t as tagPropType, d as useMenu, u as useLocation, b as Link, N as NavLink, A as APIServices, R as Row, C as Col, j as configureStore } from "./index-BtyINLIY.js";
      ...
      try {
        ...
        if (userData2) {
          const profilePic = getProfilePictureUrl(
            ...
            ProfileService.returnImage() || user16
          );
          setfaces6(profilePic);
          setUserData({
            staff_name: userData2.staff_name || userData2.email || "John Thomson",
            email: userData2.email || "",
            userType: userData2.userType || "App Developer"
          });
        }
      } catch (error) {
