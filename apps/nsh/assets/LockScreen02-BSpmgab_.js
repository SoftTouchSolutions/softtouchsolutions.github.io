  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-md-flex", onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-40 bg-style h-100vh page-style", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-single-content", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "card-body text-white py-5 px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: png, alt: "img", className: "w-100 mx-auto text-center" }) })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-80 page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-single-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Col, { md: 6, className: "mx-auto d-block", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-4 ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "avatar avatar-xxl  brround", style: { backgroundImage: `url(${user16})` } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "m-4 d-none d-lg-block text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "", children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "John Thomson" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "password", className: "form-control", id: "exampleInputPassword1", placeholder: "Password" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: `${"/apps/nsh/"}dashboard/dashboard01`, className: "btn btn-lg btn-primary btn-block", children: [
