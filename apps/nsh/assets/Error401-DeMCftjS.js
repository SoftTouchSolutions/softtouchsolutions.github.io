...
const Error401 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", onClick: () => {
      switcherIconReomve();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container text-center  relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "display-1 text-white mb-5 font-weight-bold", children: "401" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "h3  mb-3 font-weight-bold text-white", children: "Un Authorized Error!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "h5 font-weight-normal mb-7 leading-normal text-white-80", children: "You may have mistyped the address or the page may have moved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { className: "btn btn-secondary", to: `${"/apps/nsh/"}dashboard/dashboard01`, children: [
