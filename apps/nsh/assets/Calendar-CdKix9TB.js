import { r as reactExports, a as React, b as reactDomExports, j as jsxRuntimeExports } from "./mui-BeFIxXnL.js";
...
function k$1(n2, l2, u2, i2, t2) {
  var r2;
  for (r2 in u2) "children" === r2 || "key" === r2 || r2 in l2 || g$2(n2, r2, null, u2[r2], i2);
  for (r2 in l2) t2 && "function" != typeof l2[r2] || "children" === r2 || "key" === r2 || "value" === r2 || "checked" === r2 || u2[r2] === l2[r2] || g$2(n2, r2, l2[r2], u2[r2], i2);
}
...
function g$2(n2, l2, u2, i2, t2) {
  ...
  n: if ("style" === l2) if ("string" == typeof u2) n2.style.cssText = u2;
    ...
    if ("string" == typeof i2 && (n2.style.cssText = i2 = ""), i2) for (l2 in i2) u2 && l2 in u2 || b$1(n2.style, l2, "");
    if (u2) for (l2 in u2) i2 && u2[l2] === i2[l2] || b$1(n2.style, l2, u2[l2]);
  }
  else if ("o" === l2[0] && "n" === l2[1]) r2 = l2 !== (l2 = l2.replace(/Capture$/, "")), l2 = l2.toLowerCase() in n2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? i2 || n2.addEventListener(l2, r2 ? w$2 : m$1, r2) : n2.removeEventListener(l2, r2 ? w$2 : m$1, r2);
...
function $$1() {
  ...
  }); n2 = r$1.shift(); ) n2.__d && (l2 = r$1.length, i2 = void 0, t2 = void 0, f2 = (o2 = (u2 = n2).__v).__e, (e2 = u2.__P) && (i2 = [], (t2 = h({}, o2)).__v = o2.__v + 1, M(e2, o2, t2, u2.__n, void 0 !== e2.ownerSVGElement, null != o2.__h ? [f2] : null, i2, null == f2 ? A(o2) : f2, o2.__h), N(i2, o2), o2.__e != f2 && P$1(o2)), r$1.length > l2 && r$1.sort(function(n3, l3) {
    return n3.__v.__b - l3.__v.__b;
  }));
  $$1.__r = 0;
}
function H$1(n2, l2, u2, i2, t2, r2, o2, f2, e2, a2) {
  ...
  for (u2.__k = [], h2 = 0; h2 < l2.length; h2++) if (null != (d2 = u2.__k[h2] = null == (d2 = l2[h2]) || "boolean" == typeof d2 ? null : "string" == typeof d2 || "number" == typeof d2 || "bigint" == typeof d2 ? p(null, d2, null, null, d2) : Array.isArray(d2) ? p(_, { children: d2 }, null, null, null) : d2.__b > 0 ? p(d2.type, d2.props, d2.key, d2.ref ? d2.ref : null, d2.__v) : d2)) {
  ...
  for (u2.__e = b2, h2 = w2; h2--; ) null != m2[h2] && ("function" == typeof u2.type && null != m2[h2].__e && m2[h2].__e == u2.__d && (u2.__d = L$1(i2).nextSibling), q(m2[h2], m2[h2]));
  if (g2) for (h2 = 0; h2 < g2.length; h2++) S(g2[h2], g2[++h2], g2[++h2]);
}
function I$1(n2, l2, u2) {
  for (var i2, t2 = n2.__k, r2 = 0; t2 && r2 < t2.length; r2++) (i2 = t2[r2]) && (i2.__ = n2, l2 = "function" == typeof i2.type ? I$1(i2, l2, u2) : z$1(u2, i2, i2, t2, i2.__e, l2));
  return l2;
}
function j$2(n2, l2) {
...
function L$1(n2) {
  ...
  if (n2.__k) {
    for (l2 = n2.__k.length - 1; l2 >= 0; l2--) if ((u2 = n2.__k[l2]) && (i2 = L$1(u2))) return i2;
  }
  return null;
}
...
function O(l2, u2, i2, t2, r2, o2, f2, e2) {
  ...
  if (null === d2) y2 === p2 || e2 && l2.data === p2 || (l2.data = p2);
    ...
    if (k$1(l2, p2, y2, r2, e2), h2) u2.__k = [];
    else if (_2 = u2.props.children, H$1(l2, Array.isArray(_2) ? _2 : [_2], u2, i2, t2, r2 && "foreignObject" !== d2, o2, f2, o2 ? o2[0] : i2.__k && A(i2, 0), e2), null != o2) for (_2 = o2.length; _2--; ) null != o2[_2] && v$1(o2[_2]);
...
function D$1(u2, i2, t2) {
  var r2, o2, f2;
  l$1.__ && l$1.__(u2, i2), o2 = (r2 = false) ? null : i2.__k, f2 = [], M(i2, u2 = i2.__k = y(_, null, [u2]), o2 || c$1, c$1, void 0 !== i2.ownerSVGElement, o2 ? null : i2.firstChild ? n.call(i2.childNodes) : null, f2, o2 ? o2.__e : i2.firstChild, r2), N(f2, u2);
}
function G$1(n2, l2) {
...
}, t = false, x$1.prototype.setState = function(n2, l2) {
  var u2;
  ...
  render() {
    ...
    if (customGenerator != null) {
      ...
      if (customGeneratorRes === true) {
        ...
        } else if (isObject ? i$1(customGeneratorRes) : typeof customGeneratorRes !== "function") {
...
function similarNumArrays(a2, b2) {
  ...
  for (let i2 = 0; i2 < len; i2++) {
    if (Math.round(a2[i2]) !== Math.round(b2[i2])) {
      return false;
    }
  }
  return true;
...
class StandardEvent extends BaseComponent {
  render() {
    ...
    return y(EventContainer, Object.assign({}, props, { elTag: "a", elStyle: {
      borderColor: ui.borderColor,
      backgroundColor: ui.backgroundColor
    }, elAttrs: getSegAnchorAttrs(seg, context), defaultGenerator: renderInnerContent$1$1, timeText }), (InnerContent, eventContentArg) => y(
      _,
      null,
...
class FullCalendar extends reactExports.Component {
  ...
  render() {
    ...
    for (const customRendering of this.state.customRenderingMap.values()) {
      customRenderingNodes.push(React.createElement(CustomRenderingComponent, { key: customRendering.id, customRendering }));
    }
  ...
  componentDidMount() {
    ...
    customRenderingStore.subscribe((customRenderingMap) => {
      ...
      const runFunc = (
        ...
        isMounting || this.isUpdating || this.isUnmounting || requestTimestamp - lastRequestTimestamp < 100 ? runNow : reactDomExports.flushSync
      );
      runFunc(() => {
...
class TableListItemEvent extends BaseComponent {
  render() {
    ...
    return y(EventContainer, Object.assign({}, props, { elTag: "a", elClasses: ["fc-daygrid-event", "fc-daygrid-dot-event"], elAttrs: getSegAnchorAttrs(props.seg, context), defaultGenerator: renderInnerContent$1, timeText, isResizing: false, isDateSelecting: false }));
  }
}
...
class TableCell extends DateComponent {
  ...
  render() {
    ...
    return y(DayCellContainer, { elTag: "td", elRef: this.handleRootEl, elClasses: [
      ...
      props.showWeekNumber && y(WeekNumberContainer, { elTag: "a", elClasses: ["fc-daygrid-week-number"], elAttrs: buildNavLinkAttrs(context, date, "week"), date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT$1 }),
...
class TimeColsSlatsBody extends BaseComponent {
  render() {
    ...
    return y("tbody", null, props.slatMetas.map((slatMeta, i2) => {
      let renderProps = {
        time: slatMeta.time,
      ...
      y(
        ...
        y(
          ...
          y(
            ...
            props.cells.map((cell, i2) => y(TimeCol, { key: cell.key, elRef: this.cellElRefs.createRef(cell.key), dateProfile: props.dateProfile, date: cell.date, nowDate: props.nowDate, todayRange: props.todayRange, extraRenderProps: cell.extraRenderProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, extraDateSpan: cell.extraDateSpan, fgEventSegs: fgEventSegsByRow[i2], bgEventSegs: bgEventSegsByRow[i2], businessHourSegs: businessHourSegsByRow[i2], nowIndicatorSegs: nowIndicatorSegsByRow[i2], dateSelectionSegs: dateSelectionSegsByRow[i2], eventDrag: eventDragByRow[i2], eventResize: eventResizeByRow[i2], slatCoords: props.slatCoords, eventSelection: props.eventSelection, forPrint: props.forPrint }))
          )
        )
      )
    );
...
const Calendar2 = () => {
    ...
    calendarEvents: [
      {
        ...
        start: /* @__PURE__ */ new Date("2019-04-04 00:00"),
        id: "1001"
      },
      {
        title: "My Favorite Murder",
        start: /* @__PURE__ */ new Date("2019-04-05 00:00"),
        id: "1002"
      }
    ],
    events: [
  ...
  const [state] = reactExports.useState(initialstate1);
  reactExports.useEffect(() => {
    let draggableEl = document.getElementById("external-events");
    new ExternalDraggable(draggableEl, {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { xl: 3, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "", children: "Event List" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { className: "", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "external-events", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Draggable Events" }),
            state.events.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event ${event.bg} ${event.border}`,
                title: event.title,
                datatype: event.id,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fc-event-main", children: event.title })
              },
              event.id
            ))
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { xl: 9, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "main-content-body main-content-body-calendar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "main-calendar", id: "calendar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        FullCalendar,
        {
          plugins: [
            index$2,
