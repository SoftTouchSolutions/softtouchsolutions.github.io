...
import { p as png } from "./1-2rUKNz8n.js";
import { R as Row, b as Link, h as CardBody, C as Col, I as Input } from "./index-CPwjB16p.js";
...
const UnderConstruction = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "header-setting-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "demo-icon nav-link p-0 m-2 ", to: "#", onClick: () => swichermainright(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "header-icon fa-spin", x: "1008", y: "1248", viewBox: "0 0 24 24", height: "24", width: "24", preserveAspectRatio: "xMidYMid meet", focusable: "false", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-md-flex", onClick: () => {
      switcherIconReomve();
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-40 bg-style h-100vh page-style", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-single-content", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo1, alt: "img", className: "header-brand-img mb-5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: " text-white py-5 px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: png, alt: "img", className: "w-100 mx-auto text-center" }) })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-80 page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-single-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { lg: 8, sm: 12, className: "center-block align-items-center construction  ", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "construction-body text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { className: " ", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "display-5 mb-2 font-weight-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Under Construction" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Our website is in Under construction" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "launch_date" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "col-9 d-block mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(InputGroup, { className: "input-group mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-addon bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "svg-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", className: "form-control", placeholder: "Enter Your Email" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "#", className: "input-group-text bg-white p-2 btn", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "svg-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4 8.25l7.51 1-7.5-3.22zm.01 9.72l7.5-3.22-7.51 1z", opacity: ".3" }),
