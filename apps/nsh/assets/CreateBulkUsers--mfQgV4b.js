import { r as reactExports, a as React, P as PropTypes, j as jsxRuntimeExports } from "./mui-BeFIxXnL.js";
import { f as PageHeaders, g as Card, n as CardHeader, B as Button, h as CardBody, F as Form, E as FormGroup, L as Label, T as Table, o as Spinner, p as Alert, w as Modal, x as ModalHeader, y as ModalBody, z as ModalFooter, k as useDispatch, A as APIServices, S as Swal } from "./index-DlTQ3KJj.js";
 ...
 */
const plugin = ({ addFilter, utils: utils2 }) => {
  const {
    Type,
    isString,
    replaceInString,
...
var Download = reactExports.forwardRef(function(_ref, ref) {
...
var FileText = reactExports.forwardRef(function(_ref, ref) {
...
var Info = reactExports.forwardRef(function(_ref, ref) {
...
const ExcelTemplateGenerator = {
  ...
  // Modify template generation to always include a default role
  generateTemplate: function() {
    const worksheet = utils.aoa_to_sheet([
      this.userColumns,
      ["john.doe@example.com", "Test123", "user", "John Doe", "Software Developer", "Permanent", "IT"]
      // Explicitly set default role
    ]);
    const workbook = utils.book_new();
    utils.book_append_sheet(workbook, worksheet, "User Upload Template");
    writeFileSync(workbook, "Bulk_User_Upload_Template.xlsx");
  },
  // Modify validation to ensure userType is not empty
  validateExcelFile: function(jsonData) {
    const expectedColumns = this.userColumns;
    const headers = jsonData[0];
    const headersMatch = expectedColumns.every(
      (col, index) => headers[index].toLowerCase().trim() === col.toLowerCase().trim()
    );
    if (!headersMatch) {
      throw new Error("Excel file headers do not match the expected template.");
    }
    return true;
  }
};
const useBulkUserUpload = () => {
  ...
  const processExcelFile = reactExports.useCallback((file) => {
    if (!file) {
      setUploadStatus("No valid file provided.");
      return;
    }
    ...
    reader.onload = (e) => {
      try {
        ...
        const jsonData2 = utils.sheet_to_json(firstSheet, {
          header: 1,
          defval: null
        });
        if (!jsonData2 || jsonData2.length <= 1) {
          throw new Error("No data found in the Excel file.");
        }
        ExcelTemplateGenerator.validateExcelFile(jsonData2);
        const validRows = jsonData2.slice(1);
        const processedData = validRows.map((row) => {
          console.log("Processing row:", row);
          return ExcelTemplateGenerator.userColumns.reduce((acc, header, index) => {
            const key = header.toLowerCase().replace(/\s+/g, "_");
            if (key === "usertype") {
              const value = row[index] !== null ? row[index].toString().trim() : "default_user";
              acc[key] = value || "default_user";
            } else if (key === "job_role" || key === "contract_type") {
              acc[key] = row[index] !== null ? row[index].toString().trim() : "";
            } else {
              acc[key] = row[index] !== null ? row[index].toString().trim() : "";
            }
            return acc;
        ...
        const validatedData = processedData.filter((item) => {
          ...
          return item.email && item.password && item.usertype;
        });
        if (validatedData.length === 0) {
          throw new Error("No valid user data found in the file.");
        }
        setJsonData(validatedData);
        setUploadStatus(`File processed successfully. ${validatedData.length} valid entries found.`);
      } catch (error) {
    ...
    reader.onerror = (error) => {
      ...
      setUploadStatus("File reading failed.");
      setErrorDetails(error);
    };
    reader.readAsArrayBuffer(file);
  }, []);
  const handleFileUpload = reactExports.useCallback((fileItems) => {
    setJsonData(null);
    setUploadStatus("");
    setErrorDetails(null);
    setFiles(fileItems);
    if (fileItems.length > 0) {
      processExcelFile(fileItems[0].file);
    }
  }, [processExcelFile]);
  const handleSubmit = reactExports.useCallback(async () => {
    if (!jsonData || jsonData.length === 0) {
      setUploadStatus("No data to submit.");
      return;
    }
    console.log("Data Being Submitted:", jsonData);
    setIsLoading(true);
    setUploadStatus("");
    setErrorDetails(null);
    try {
      const response = await APIServices.bulkCreateUsers(jsonData, dispatch);
      console.log("API Response:", response);
      Swal.fire({
        title: "Success",
        text: "Users submitted successfully!",
        icon: "success",
        confirmButtonText: "OK"
      });
      setUploadStatus(`Successfully created ${response.length || jsonData.length} users.`);
      setJsonData(null);
      setFiles([]);
    } catch (error) {
  ...
  const toggleTemplateModal = reactExports.useCallback(() => {
    setTemplateModalOpen((prevState) => !prevState);
  }, []);
  const resetUpload = reactExports.useCallback(() => {
    setFiles([]);
    setJsonData(null);
    setUploadStatus("");
    setErrorDetails(null);
...
const CreateBulkUsers = () => {
  ...
  const [formValidation, setFormValidation] = reactExports.useState({
    fileUploaded: false,
    dataProcessed: false
  });
  reactExports.useEffect(() => {
    setFormValidation((prev) => ({
      ...
      dataProcessed: !!jsonData
    }));
  }, [files, jsonData]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bulk-user-upload-container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "d-flex justify-content-between align-items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "mb-0", children: "Bulk User Upload" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 16, className: "mr-2" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(FormGroup, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Upload Excel File" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              FilePond,
              {
                files,
                ...
                labelIdle: 'Drag & Drop Excel File or <span class="filepond--label-action">Browse</span>'
              }
            )
          ] }),
          jsonData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "data-preview", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { children: "Data Preview" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { responsive: true, striped: true, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: ExcelTemplateGenerator.userColumns.map((column, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: column }, index)) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: jsonData.slice(0, 5).map((row, rowIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: ExcelTemplateGenerator.userColumns.map((column, colIndex) => {
                const key = column.toLowerCase().replace(/\s+/g, "_");
                return /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row[key] }, colIndex);
              }) }, rowIndex)) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex justify-content-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                disabled: !formValidation.dataProcessed || isLoading,
            ...
            jsonData && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                color: "secondary",
                onClick: resetUpload,
        ...
        uploadStatus && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Alert,
          {
            color: uploadStatus.includes("failed") ? "danger" : "success",
            className: "mt-3",
            children: uploadStatus
          }
        ),
        errorDetails && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-details text-danger mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: errorDetails.toString() }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { isOpen: templateModalOpen, toggle: toggleTemplateModal, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModalHeader, { toggle: toggleTemplateModal, children: "Excel Template Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalBody, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { children: "Required Columns" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { bordered: true, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Column Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Description" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: ExcelTemplateGenerator.userColumns.map((column, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: column }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
                column === "email" && "Unique email address",
                column === "password" && "User's password",
                column === "userType" && "User role in the system",
                column === "staff_name" && "User's Name",
                column === "job_role" && "User's job position or role",
                column === "contract_type" && "Employment contract type (e.g., Permanent, Contract)",
                column === "department" && "User's department"
              ] })
            ] }, index)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { color: "info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { size: 16, className: "mr-2" }),
            "Ensure all columns are filled correctly to avoid upload errors."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModalFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { color: "secondary", onClick: toggleTemplateModal, children: "Close" }) })
      ] })
    ] })
  ] });
};
export {
  CreateBulkUsers as default
};
