...
import { R as Row, b as Link, C as Col, g as Card, h as CardBody, p as Alert, I as Input, L as Label } from "./index-Dr-4baW5.js";
...
const ForgetPassword01 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.agreeTerms) {
      setMessage({ type: "error", text: "Please agree to the terms and policy." });
      return;
    }
    setLoading(true);
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ email: "", agreeTerms: false });
      } else {
        const errorData = await response.json();
        setMessage({
          type: "error",
          text: errorData.detail || "Failed to send reset link. Please try again."
        });
      }
    } catch (error) {
      setMessage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-single", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "justify-content-center", onClick: () => {
      switcherIconReomve();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Col, { md: 5, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: " p-4 mb-0 mt-7 mt-md-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { className: "", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center title-style mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted", children: "Enter your email address and we'll send you a link to reset your password." })
        ] }),
        message.text && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: message.type === "error" ? "danger" : "success", className: "mb-4", children: message.text }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "submit",
              className: "btn btn-lg btn-primary btn-block px-4",
              disabled: loading || !formData.email || !formData.agreeTerms,
