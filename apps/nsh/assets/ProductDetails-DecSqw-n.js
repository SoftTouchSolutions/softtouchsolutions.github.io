...
import { af as connect_default, ag as useParams, s as PageHeaderstyle, R as Row, C as Col, g as Card, n as CardHeader, h as CardBody, b as Link, L as Label, I as Input, T as Table } from "./index-Dr-4baW5.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { className: "", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { md: "12", className: " wrapper wrapper-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "ibox", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { className: "ibox-content text-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-list", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `${"/apps/nsh/"}pages/ecommerce/shoppingcart`, className: "btn btn-light", children: "Buy Now" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `${"/apps/nsh/"}pages/ecommerce/shoppingcart`, className: "btn btn-primary", children: "Add to cart" })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { xl: "4", md: "6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "item-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-top p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: `${"/apps/nsh/"}pages/ecommerce/productdetails`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: `${"/apps/nsh/"}pages/ecommerce/shoppingcart`, className: "btn btn-primary btn-svgs mt-1 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "svg",
              {
                className: "svg-icon",
