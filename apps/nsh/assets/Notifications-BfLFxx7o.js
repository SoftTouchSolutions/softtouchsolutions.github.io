import { r as reactExports, a as React, e as clsx, j as jsxRuntimeExports } from "./mui-BeFIxXnL.js";
import { f as PageHeaders, R as Row, C as Col, g as Card, n as CardHeader, h as CardBody, B as Button, b as Link } from "./index-DlTQ3KJj.js";
import { C as CardTitle } from "./CardTitle-DskoHL-1.js";
import { U as UncontrolledPopover, P as PopoverHeader, a as PopoverBody } from "./PopoverBody-Ci-3vDLV.js";
...
const Notifications = () => {
  const DefaultTostify = () => {
    B.success(
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Success: Well done Details Submitted Successfully" }),
      {
        position: B.POSITION.TOP_RIGHT,
  ...
  const CenterToastify = () => B.error(
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Oops! An Error Occurred" }),
    {
  ...
  const LeftNotifier = () => B.warn(
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Warning: Something Went Wrong" }),
    {
      position: B.POSITION.TOP_LEFT,
      hideProgressBar: true,
      autoClose: 2e3,
      theme: "colored"
    }
  );
  const InfoTostifier = () => B.info(/* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Info: Some info here." }), {
    position: B.POSITION.TOP_CENTER,
    hideProgressBar: true,
    autoClose: 2e3,
    theme: "colored"
  });
  const DangerNotifier = () => B.error(
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Error: This error will stay here until you click it." }),
    {
      position: B.POSITION.TOP_CENTER,
      hideProgressBar: true,
      autoClose: 2e3,
  ...
  const WarningNotifier = () => B.warn(/* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Opacity is cool!" }), {
    position: B.POSITION.TOP_CENTER,
    hideProgressBar: true,
    autoClose: 2e3,
    theme: "colored"
  ...
  let togleTost = (type) => {
    switch (type) {
      case "Primary":
        B.success(
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "welcome To VALEX" }),
          {
            position: B.POSITION.TOP_RIGHT,
            hideProgressBar: true,
            autoClose: 2e3,
      ...
      case "Info":
        B.info(
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white tx-16 mb-0", children: "Info: Some info here." }),
          {
            position: B.POSITION.TOP_CENTER,
            hideProgressBar: true,
            autoClose: 2e3,
      ...
      case "FixedError":
        B.error(
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white tx-16 mb-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Error!" }),
            "please check Your details ...file is missing"
          ] }),
          {
            position: B.POSITION.TOP_RIGHT,
            hideProgressBar: true,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "notification-alert", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Col, { md: "12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { tag: "h3", children: "Alerts Styles Notifications" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { tag: "h3", children: "Side Alerts Notifications" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-list", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledPopover, { placement: "bottom", target: "success", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverHeader, { children: "Popover Title" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledPopover, { placement: "top", target: "popoverinfo", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverHeader, { children: "Popover Title" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledPopover, { placement: "bottom", target: "warning", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverHeader, { children: "Popover Title" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledPopover, { placement: "top", target: "secondary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverHeader, { children: "Popover Title" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledPopover, { placement: "bottom", target: "danger", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverHeader, { children: "Popover Title" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledPopover, { placement: "top", target: "primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverHeader, { children: "Popover Title" }),
