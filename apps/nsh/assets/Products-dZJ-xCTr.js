import { r as reactExports, a as React, j as jsxRuntimeExports } from "./mui-BeFIxXnL.js";
import { af as connect_default, s as PageHeaderstyle, R as Row, C as Col, g as Card, h as CardBody, I as Input, B as Button, n as CardHeader, L as Label, z as FormGroup, b as Link, G as Pagination, H as PaginationItem, J as PaginationLink } from "./index-Dr-4baW5.js";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Col, { xl: "9", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: allData.map((list) => /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { xl: "4", lg: "6", sm: "6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "item-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center border-top p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: `${"/apps/nsh/"}pages/ecommerce/productdetails/${list.id}`, className: "btn btn-light btn-svgs mt-1 mb-1 me-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: `${"/apps/nsh/"}pages/ecommerce/shoppingcart`, onClick: () => {
              AddToCart2(list.id);
