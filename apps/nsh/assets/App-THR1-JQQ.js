...
import { R as Row, I as Input, L as Label, B as Button, u as useLocation, a as useNavigate, b as Link, F as Form, D as DropdownMenu, c as DropdownToggle, A as APIServices, d as useMenu, S as Swal, P as Provider_default, e as AuthProvider, M as MenuProvider, O as Outlet } from "./index-zbnKGqDS.js";
import "./firebase-DfbfLo-p.js";
import { u as useSidebarState, N as Navbar, l as logo, a as NavbarToggler, s as store, S as SidebarProvider, b as Sidebar, F as Footer, T as TabToTop } from "./store-BoeMaND4.js";
import { U as UncontrolledDropdown, D as DropdownItem } from "./UncontrolledDropdown-Dg1sDLqX.js";
import { C as Collapse } from "./Collapse-CKNqFcjd.js";
...
const Header = () => {
  ...
  reactExports.useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const user = (response == null ? void 0 : response.data) || response;
        if (user) {
          setUserData({
            staff_name: user.staff_name || user.email || "User not found",
            userType: user.userType || "UserType Not Found",
            email: user.email || "",
            profilePicture: getProfilePictureUrl(user.profile_picture, user1)
          });
        }
      } catch (error) {
  ...
  const [faces6, setImage] = reactExports.useState(user1);
