...
import { R as Row, b as Link } from "./index-CPwjB16p.js";
import "./vendor-DcOWwNOt.js";
import "./utils-pMlYcaaZ.js";
const Errors = "/apps/nsh/assets/404-Cd-2DXOG.svg";
const Error404 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: Errors, alt: "img", className: "w-30 mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "h3  mb-3 font-weight-bold", children: "Sorry, an error has occured, Requested Page not found!" }),
