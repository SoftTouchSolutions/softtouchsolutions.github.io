...
function geoPath(projection2, context) {
  ...
  path.projection = function(_) {
    return arguments.length ? (projectionStream = _ == null ? (projection2 = null, identity$1) : (projection2 = _).stream, path) : projection2;
  };
...
function useZoomPan(_ref) {
  ...
  var wheelTimer = reactExports.useRef(null);
  ...
  var point = reactExports.useRef();
  var isPointerDown = reactExports.useRef(false);
  var pointerOrigin = reactExports.useRef();
...
const WorldMap = ({ setTooltipContent }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ComposableMap, { projectionConfig: { scale: 200 }, className: "worldmaps", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomableGroup, { zoom: 1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Geographies, { geography: geoUrl, children: ({ geographies }) => geographies.map((geo) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Geography$1,
    {
      geography: geo,
      style: {
...
const geoUrl1 = "https://raw.githubusercontent.com/deldersveld/topojson/master/continents/europe.json";
const Europemap = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ComposableMap,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Graticule$1, { stroke: "#a5a3b1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Geographies, { geography: geoUrl1, children: ({ geographies }) => geographies.map((geo) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Geography$1,
          {
            geography: geo,
            fill: "#9998A3",
...
const MapAnnotation = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ComposableMap,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ZoomableGroup, { zoom: 1, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Geographies,
          {
            ...
            stroke: "#FFFFFF",
            strokeWidth: 5,
            children: ({ geographies }) => geographies.map((geo) => /* @__PURE__ */ jsxRuntimeExports.jsx(Geography$1, { geography: geo }, geo.rsmKey))
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Annotation,
...
const geoUrlBasicmarkers = "https://raw.githubusercontent.com/deldersveld/topojson/master/continents/south-america.json";
...
const Basicmarkers = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ComposableMap,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Geographies, { geography: geoUrlBasicmarkers, children: ({ geographies }) => geographies.map((geo) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Geography$1,
          {
            geography: geo,
            fill: "#EAEAEC",
        ...
        Basicmarkersdata.map(({ name, coordinates, markerOffset }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Marker, { coordinates, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { r: 10, fill: "#F00", stroke: "#fff", strokeWidth: 2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "text",
            {
              textAnchor: "middle",
...
const geoUrlCustommarkers = "https://raw.githubusercontent.com/deldersveld/topojson/master/continents/south-america.json";
...
const Custommarkers = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ComposableMap,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Geographies, { geography: geoUrlCustommarkers, children: ({ geographies }) => geographies.map((geo) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Geography$1,
          {
            geography: geo,
            fill: "#EAEAEC",
        ...
        Custommarkersdata.map(({ name, coordinates, markerOffset }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Marker, { coordinates, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 21.7C17.3 17 20 13 20 10a8 8 0 1 0-16 0c0 3 2.7 6.9 8 11.7z" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const Shapeworldmap = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ComposableMap, { projectionConfig: { scale: 147 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Graticule$1, { stroke: "lightgrey" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Geographies, { geography: geoUrl, stroke: "lightgrey", children: ({ geographies }) => geographies.map((geo) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Geography$1,
      {
        geography: geo,
        style: {
