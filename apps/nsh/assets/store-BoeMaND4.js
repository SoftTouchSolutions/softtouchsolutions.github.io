import { a as React, P as PropTypes, r as reactExports, j as jsxRuntimeExports } from "./mui-6YGer9Nu.js";
import { m as mapToCssModules, i as classnames, t as tagPropType, d as useMenu, u as useLocation, b as Link, N as NavLink, A as APIServices, R as Row, C as Col, j as configureStore } from "./index-zbnKGqDS.js";
...
const logo = "/apps/nsh/assets/logo-BjCkGc0t.svg";
...
const SidebarProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContext.Provider, { value: {
    isSidebarExpanded,
    toggleSidebar,
    expandSidebar,
    collapseSidebar
...
const Sidebar = () => {
  ...
  const { isSidebarExpanded, expandSidebar, collapseSidebar } = useSidebarState();
  const [outPut, setoutPut] = reactExports.useState(EditProfileService.returnId());
  const [userData, setUserData] = reactExports.useState({ staff_name: "John Thomson", email: "", userType: "App Developer", profilePicture: user1 });
  reactExports.useEffect(() => {
  ...
  const [faces6, setfaces6] = reactExports.useState(user1);
  reactExports.useEffect(() => {
    const loadUserData = async () => {
      try {
        const response = await APIServices.getCurrentUser();
        const userData2 = (response == null ? void 0 : response.data) || response;
        if (userData2) {
          const profilePic = getProfilePictureUrl(
            userData2.profile_picture,
            ProfileService.returnImage() || user1
          );
          setfaces6(profilePic);
          setUserData({
            staff_name: userData2.staff_name || userData2.email || "User not found",
            userType: userData2.userType || "UserType Not Found",
            email: userData2.email || "",
            profilePicture: getProfilePictureUrl(userData2.profile_picture, user1)
          });
        }
      } catch (error) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      onMouseOut: () => Outhover(),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "main-sidebar-header active", style: { display: "flex", justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "desktop-logo logo-light active", to: `dashboard/dashboard01`, style: { display: "flex", justifyContent: "center", width: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
          fontSize: "1.75rem",
          fontWeight: "bold",
          color: "#4169E1",
          textShadow: "1px 1px 2px rgba(0,0,0,0.3)",
          letterSpacing: "2px",
          fontFamily: "Nunito, Quicksand, Varela Round, Comfortaa, sans-serif",
          textAlign: "center"
        }, children: isSidebarExpanded ? "NSHRM" : "N" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleBar, { className: "sidebar-menuscroll", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-sidemenu is-expanded", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-sidebar__user", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown user-pro-body text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "user-pic", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { alt: "user-img", className: "avatar avatar-xl brround mb-1", src: userData.profilePicture || faces6 || user1 }) }),
