...
import { R as Row, b as Link, C as Col, r as Progress, I as Input } from "./index-AOv_UoEY.js";
...
const ComingSoon = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "header-setting-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "demo-icon nav-link p-0 m-2 ", to: "#", onClick: () => swichermainright(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page relative", onClick: () => {
      switcherIconReomve();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "display-2 text-primary mb-5 font-weight-bold", children: "Coming soon" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "h3  mb-3 font-weight-bold", children: "Thank you for being stayed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "h5 font-weight-normal mb-4 leading-normal", children: "You may have mistyped the address or the page may have moved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { md: 6, className: "d-block mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "text-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge bg-primary rounded-pill", children: "Working" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "col-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fs-18 font-weight-bold", children: "60%" }) })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-wrapper mb-5 col-md-6 d-block mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Progress,
        {
          className: "",
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "coming-footer border-top border-dark-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-block mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "h5 mb-4 leading-normal", children: "Notify Me When there's Some Action." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "input-group-addon bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              className: "svg-icon",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "#", className: "input-group-text bg-white p-2 btn", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              className: "svg-icon",
              xmlns: "http://www.w3.org/2000/svg",
