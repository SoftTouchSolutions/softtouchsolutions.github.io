...
import { m as mapToCssModules, i as classnames, t as tagPropType, d as useMenu, u as useLocation, b as Link, N as NavLink, A as APIServices, R as Row, C as Col, j as configureStore } from "./index-Dr-4baW5.js";
import { S as SimpleBar } from "./index-DWkztd76.js";
import { f as favicon1 } from "./favicon1-IUYgMLTj.js";
    ...
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-sidebar-header active", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "desktop-logo logo-light active", to: `${"/apps/nsh/"}dashboard/dashboard01`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, className: "main-logo", alt: "logo" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "desktop-logo logo-dark active", to: `${"/apps/nsh/"}dashboard/dashboard01`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo1, className: "main-logo", alt: "logo" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "logo-icon mobile-logo icon-light active", to: `${"/apps/nsh/"}dashboard/dashboard01`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: favicon, alt: "logo" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "logo-icon mobile-logo icon-dark active", to: `${"/apps/nsh/"}dashboard/dashboard01`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: favicon1, alt: "logo" }) })
        ] }),
