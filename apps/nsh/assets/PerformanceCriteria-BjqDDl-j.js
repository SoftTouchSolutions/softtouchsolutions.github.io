...
import { B as Button, U as Table, a3 as Pagination, a4 as PaginationItem, a5 as PaginationLink, Z as Modal, _ as ModalHeader, $ as ModalBody, F as Form, L as Label, I as Input } from "./index-DTmWxS77.js";
...
const PerformanceCriteriaTable = () => {
  ...
  const fetchCriteria = async () => {
    try {
      ...
      let criteriaArray = [];
      if (Array.isArray(result)) criteriaArray = result;
      else if (result && Array.isArray(result.criteria)) criteriaArray = result.criteria;
      else if (result && Array.isArray(result.data)) criteriaArray = result.data;
      else criteriaArray = [];
