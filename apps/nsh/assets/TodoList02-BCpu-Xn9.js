...
import { v as PageHeaderstyle, R as Row, C as Col, g as Card, B as Button, h as CardBody, L as Label, I as Input, c as DropdownToggle, D as DropdownMenu } from "./index-DlTQ3KJj.js";
...
const data = [
  {
    ...
    p1: "Work Assigned by Clients ,try to get new work",
    p2: "Sed ut perspiciatis unde omnis iste natus",
    work: "React Developer"
  },
  {
    photo: user2,
    name: "Margarette Wycoff",
    p1: "Voluptatem Accusantium Dolo Laudantium",
    p2: "Inventore Veritatis Et Quasi Architecto",
    work: "React Developer"
  },
  {
    photo: user3,
    name: "Myrta Powe",
    p1: "Nemo Enim Ipsam Voluptatem Quia Voluptas",
    p2: "Vero Eos Et Accusamus Et Iusto Odio Dignissimos",
    work: "React Developer"
  },
  {
    photo: user4,
    name: "Consuelo Valenzuela",
    p1: "Ut Enim Ad Minima Veniam Nostrum Exercitationem",
    p2: "Quis Autem Vel Eum Iure Reprehenderit Qui",
    work: "React Developer"
  },
  {
    photo: user5,
    name: "Carolyne Wirtz",
    p1: "I Must Explain To You How All This Mistaken",
    p2: "I Will Give You A Complete Account Of The System",
    work: "React Developer"
  },
  {
    photo: user6,
    name: "Archie Kesler",
    p1: "Rationally Encounter Quences Extremely Painful",
    p2: "Which Of Us Ever Undertakes Laborious Physical",
    work: "React Developer"
  }
];
const TodoList02 = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeaderstyle, { title: "Todo List", home: "Home", Pages: "Apps", elements: "Todo List", name: "Todo List 02" }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { md: 12, lg: 4, xl: 3, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "card-body border-top", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Nav,
        {
          vertical: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { md: 12, lg: 8, xl: 9, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { children: data.map((list, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { lg: 6, xl: 4, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardBody, { className: " p-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "todo-widget-header d-flex pb-2 p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "custom-control custom-checkbox mb-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "checkbox",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ms-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledDropdown, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { className: "tx-13 dropdown-menu-end", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Assigned to" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Mark As Unread" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Mark As Important" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Add to Tasks" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Add Star" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Move to" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Mute" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Move to Trash" })
            ] })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(UncontrolledDropdown, { className: "px-4 pb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            DropdownToggle,
            {
              tag: "a",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-weight-bold d-flex", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: list.work })
                ] })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { className: "dropdown-menu tx-13", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "View Total Tasks" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Completed Tasks" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Delete Tasks" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownItem, { className: "", children: "Settings" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-top", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "text-muted", children: "10.54am" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "mb-0  mt-2 fs-13", children: list.p1 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-top", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "text-muted", children: "10.54am" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "mb-0  mt-2 fs-13", children: list.p2 })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardFooter, { className: "btn-list d-flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
