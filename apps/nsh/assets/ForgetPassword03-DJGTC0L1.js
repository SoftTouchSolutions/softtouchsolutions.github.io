...
import { b as Link, R as Row, C as Col, g as Card, h as CardBody, I as Input, L as Label } from "./index-CPwjB16p.js";
import { I as InputGroup } from "./InputGroup-DN807rhS.js";
import { l as login } from "./login-BlSAtsHC.js";
...
const ForgetPassword03 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-single p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "header-setting-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { className: "demo-icon nav-link p-0 m-2 ", to: "#", onClick: () => swichermainright(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "header-icon fa-spin", x: "1008", y: "1248", viewBox: "0 0 24 24", height: "24", width: "24", preserveAspectRatio: "xMidYMid meet", focusable: "false", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: " justify-content-center mt-7 mt-sm-0", onClick: () => {
      switcherIconReomve();
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Col, { xl: 8, lg: 9, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-group mb-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4 page-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "page-single-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-100", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mb-2", children: "Forgot Password" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted", children: "Forgot Password Page" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-list d-xl-flex", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://twitter.com/", target: "_blank", className: "btn btn-info d-xl-inline d-block", children: "Twitter" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.facebook.com/", target: "_blank", className: "btn btn-primary d-xl-inline d-block me-2", children: "Facebook" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(InputGroup, { className: "input-group mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", className: "form-control", placeholder: "Enter Email" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "custom-control custom-checkbox", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "custom-control-label", children: [
              "Agree the ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `${"/apps/nsh/"}pages/terms`, children: "terms and policy" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { role: "button", to: `${"/apps/nsh/"}dashboard/dashboard01`, className: "btn btn-lg btn-primary btn-block px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "fe fe-arrow-right" }),
            " Send"
          ] }) }) })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "card text-white bg-primary py-5 d-none d-lg-block page-content mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { className: "card-body text-center justify-content-center page-single-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: login, alt: "img" }) }) })
      ] }),
