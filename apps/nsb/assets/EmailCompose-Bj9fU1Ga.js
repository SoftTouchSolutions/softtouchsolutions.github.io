...
import { Y as PageHeaderstyle, R as Row, C as Col, w as Card, q as Link, x as CardBody, K as CardHeader, F as Form, L as Label, I as Input, B as Button } from "./index-DTmWxS77.js";
...
const EmailCompose = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { lg: "4", xl: "3", md: "12", sm: "12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { lg: "8", xl: "9", md: "12", sm: "12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { tag: "h3", children: "Compose new message" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardBody, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { className: "align-items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "col-sm-2 form-label", children: "To" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { sm: "10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", className: "form-control" }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { className: "align-items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "col-sm-2 form-label", children: "Subject" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { sm: "10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "text", className: "form-control" }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Row, { className: "", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "col-sm-2 form-label", children: "Message" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Col, { sm: "10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: "10", className: "form-control" }) })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardFooter, { className: " d-sm-flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(UncontrolledTooltip, { target: "Attach", placement: "top", children: "Attach" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(UncontrolledTooltip, { target: "Links", placement: "top", children: "Link" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(UncontrolledTooltip, { target: "Photos", placement: "top", children: "Photos" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "#",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(UncontrolledTooltip, { target: "Delete", placement: "top", children: "Delete" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btn-list ms-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              color: "",
