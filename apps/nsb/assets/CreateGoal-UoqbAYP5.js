...
import { A as APIServices, S as Swal, B as Button, U as Table, a3 as Pagination, a4 as PaginationItem, a5 as PaginationLink, Z as Modal, _ as ModalHeader, $ as ModalBody, F as Form, R as Row, C as Col, L as Label, I as Input, a0 as ModalFooter, v as PageHeaders, w as Card, K as CardHeader, x as CardBody } from "./index-DTmWxS77.js";
...
const CreateGoalTable = () => {
  ...
  const fetchGoals = async () => {
    ...
    try {
      ...
      const goalsArray = Array.isArray(response) ? response : (response == null ? void 0 : response.goals) || [];
      setGoals(goalsArray);
    } catch (error) {
