import { c as createAstro, d as createComponent, r as renderTemplate, g as renderComponent, l as renderHead, e as addAttribute } from '../astro_jR4j5o-_.mjs';
import 'kleur/colors';
import 'clsx';
import { $ as $$BaseHead, a as $$Header, b as $$Footer, S as SITE_TITLE, c as SITE_DESCRIPTION, g as getCollection, d as $$FormattedDate } from './__sk1mdZm2.mjs';
/* empty css                          */
/* empty css                          */
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-kt2pfoco> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": SITE_TITLE, "description": SITE_DESCRIPTION, "data-astro-cid-kt2pfoco": true })}${renderHead()}</head> <body data-astro-cid-kt2pfoco> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-kt2pfoco": true })} <main data-astro-cid-kt2pfoco> <section data-astro-cid-kt2pfoco> <ul data-astro-cid-kt2pfoco> ${posts.map((post) => renderTemplate`<li data-astro-cid-kt2pfoco> <a${addAttribute(`/blog/${post.slug}/`, "href")} data-astro-cid-kt2pfoco> <img${addAttribute(720, "width")}${addAttribute(360, "height")}${addAttribute(post.data.heroImage, "src")} alt="" data-astro-cid-kt2pfoco> <h4 class="title" data-astro-cid-kt2pfoco>${post.data.title}</h4> <p class="date" data-astro-cid-kt2pfoco> ${renderComponent($$result, "FormattedDate", $$FormattedDate, { "date": post.data.pubDate, "data-astro-cid-kt2pfoco": true })} </p> </a> </li>`)} </ul> </section> </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-kt2pfoco": true })} </body></html>`;
